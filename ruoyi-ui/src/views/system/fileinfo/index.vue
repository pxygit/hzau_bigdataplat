    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:fileinfo:export']"
        >导出</el-button>
      </el-col>
...
import {uploadFile} from "@/api/system/fileinfo";
  ...
  methods: {
    ...
    submitUpload() {
      ...
      uploadFile(formData).then(res => {
        this.uploadResult.url = res.data.url;
        this.uploadResult.fileName = res.data.fileName;
        this.uploadResult.newFileName = res.data.newFileName;
        this.uploadResult.originalName = res.data.originalName;
